...
function nav(path){
	path = decodeURI(path);
    $('#heading').html('r.edui.fun '+path);
}

// 渲染文件列表
function list(path){
	var content = `
<tr><th class="file-name">书名</th><th class="file-size">大小</th><th class="file-date-modified">时间</th></tr>
	`;
